...
# Task 1: Develop a good feature set; what's the best performance I can get with 2 or 3 features?
'''
Pearson Correlation co-efficient:
 -1.0 - perfect neg correlation
 0 - zero correlation
 1.0 - perfect pos. correlation
'''
...
# Task 2: Making better use of latitude
...
def select_and_transform_features(source_df):
    LATITUDE_RANGES = zip(range(32, 44), range(33, 45)) # list of tuples (32,33), (33,34), .... , (44, 45)
